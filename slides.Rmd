...
- Weighing methods: gene importance
- Gene to GeneSet empirical distance
- Gene set internal Correlation
- Meta analysis: combining different studies
- Supervised Classification starting from enriched GeneSets
- Unsupervised Classification
- Much more work in data preprocessing and validation
- Incorporation of for technological biases such as gene length
- Organization of results: thousands of tables, images, plots
...
- My PhD
- Supervised one more PhD and several MSc dissertations
...
- Very similar context Risk prediction in clinic an fraud ...
